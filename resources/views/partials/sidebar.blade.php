<div id="side-bar"
            ...
            <form action="{{ route('search') }}">
                <div class="w-52 flex rounded-2xl bg-gray-100 py-2 px-3 mb-3 items-center">
                    ...
                    <input
                        ...
                        type="text" placeholder="Search Yelo" name="word" value="{{ request('word') }}" >
                </div>
    ...
    <div id="recommended-topics-box">
        ...
        <div class="topics flex flex-wrap justify-start">
            ...
            <a href=" {{ route('category' , ['category' => $category->id]) }}" class="bg-red-600 text-white rounded-xl px-3 py-1 text-base my-1 ">
                {{ $category->name }}
